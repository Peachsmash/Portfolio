           ...
           >
              ...
              >
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-4">
                      ...
                      <span className="text-lg md:text-xl font-semibold font-mono text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 underline decoration-transparent group-hover:decoration-blue-500/40 underline-offset-4 transition-all duration-300 break-all text-center">hello@maciej.design</span>
              ...
              >
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-4">
                      ...
                      <span className="text-lg md:text-xl font-semibold font-mono text-gray-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 underline decoration-transparent group-hover:decoration-emerald-500/40 underline-offset-4 transition-all duration-300 whitespace-nowrap text-center">+1 (234) 567 890</span>
