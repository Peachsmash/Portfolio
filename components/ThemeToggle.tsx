  ...
  return (
    <>
      <motion.div
        ...
        className={`fixed bottom-8 right-4 md:bottom-auto md:top-8 md:right-8 z-50 group ${isLightboxOpen ? 'pointer-events-none' : ''}`}
      >
        <button
        ...
        >
          <div className="transform scale-x-[-1] flex items-center justify-center">
            <PaintBucket
              className={`w-6 h-6 md:w-5 md:h-5 transition-all duration-500 text-gray-600 dark:text-gray-300 ${isSpilling
                ? 'rotate-[45deg]'
