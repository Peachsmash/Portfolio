...
import { Works, projectImages, projectGalleries } from './components/Works';
...
const ScrollHandler = () => {
  ...
  useEffect(() => {
    ...
    // Force scroll to top again after a tiny delay to override mobile browser restoration quirks
    // occurring during page transitions
    const scrollRetry = setTimeout(() => {
       window.scrollTo(0, 0);
    }, 40);
